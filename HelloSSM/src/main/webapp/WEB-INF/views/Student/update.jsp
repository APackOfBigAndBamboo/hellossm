        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <spring:bind path="birthday">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:label path="birthday" cssClass="control-label">生日</form:label>
                        <form:input path="birthday" cssClass="form-control" placeholder=""></form:input>
